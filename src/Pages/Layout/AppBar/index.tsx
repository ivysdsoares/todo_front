...
export default function AppBar(): JSX.Element {
    ...
    return (
        <div className="flex flex-col items-stretch justify-start w-screen h-screen min-h-screen overflow-auto min-w-screen ">
            <div className="sticky top-0 flex flex-col items-stretch justify-start shadow-md bg-form">
            ...
            <div
                ...
                className="flex flex-col items-stretch overflow-auto justify-start flex-1 p-4 "
            >
                <Outlet />
            </div>
        </div>
