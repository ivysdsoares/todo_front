...
function AppBar(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-stretch justify-start w-screen h-screen min-h-screen min-w-screen ">
      ...
      <div
        ...
        className="flex flex-col items-stretch overflow-auto justify-start flex-1 px-0 sm:px-4 p-4 "
      >
        <div className="flex flex-col static flex-1  items-stretch justify-start">
          <Outlet />
        </div>
      </div>
    </div>
